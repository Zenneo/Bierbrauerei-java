...
public class upgradeStorage extends Dialog {
	...
	private void fetchUIData() {
		...
		upgrade_small.setToolTipText("Verbessert die Lagerkapazit‰t um "
				+ roundmanager.getUpgradeStorageEffect(0)  + ". Pro Runde werden " + roundmanager.getUpgradesStorage()[0].getRoundlyCosts() + "Ä extra gezahlt");
		...
		upgrade_medium.setToolTipText("Verbessert die Lagerkapazit‰t um "
				+ roundmanager.getUpgradeStorageEffect(1)  + ". Pro Runde werden " + roundmanager.getUpgradesStorage()[1].getRoundlyCosts() + "Ä extra gezahlt");
		...
		upgrade_big.setToolTipText("Verbessert die Lagerkapazit‰t um "
				+ roundmanager.getUpgradeStorageEffect(2)  + ". Pro Runde werden " + roundmanager.getUpgradesStorage()[2].getRoundlyCosts() + "Ä extra gezahlt");
